...
class HomeTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    @objc func abrirActionSheet(_ longPress:UILongPressGestureRecognizer) {
        if longPress.state == .began {
            ...
            guard let navegation = navigationController else { return }
            let menu = MenuOpcoesAlunos().configuraMenuDeOpcoesDoAluno(navegation: navegation, alunoSelecionado: alunoSelecionado)
